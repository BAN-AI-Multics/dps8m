...
// scspell-id: d4c85f73-f62c-11ec-a704-80ee73e9b8e7
...
# define DECQUAD_Ehigh \
 ( DECQUAD_Emax + DECQUAD_Bias - ( DECQUAD_Pmax - 1 ))
...
/*
 * Sign and special values [top 32-bits; last two bits
 * are don't-care for Infinity on input, last bit is
 * don't-care for NaNs]
 */
...
# define decQuadToNumber(dq, dn) \
 decimal128ToNumber((decimal128 *)( dq ), dn)

# define decQuadFromNumber(dq, dn, set) \
 decimal128FromNumber((decimal128 *)( dq ), dn, set)

/* ######################################################################### */

#endif /* if !defined( DECQUAD ) */

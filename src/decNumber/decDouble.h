...
# define DECDOUBLE_Ehigh \
 ( DECDOUBLE_Emax + DECDOUBLE_Bias - ( DECDOUBLE_Pmax - 1 ))
...
# define decDoubleToNumber(dq, dn) \
 decimal64ToNumber((decimal64 *)( dq ), dn)
# define decDoubleFromNumber(dq, dn, set) \
 decimal64FromNumber((decimal64 *)( dq ), dn, set)

/* ######################################################################### */

#endif /* if !defined( DECDOUBLE ) */

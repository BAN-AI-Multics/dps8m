...
# define DEC_IEEE_754_Invalid_operation                                     \
 ( DEC_Conversion_syntax | DEC_Division_impossible | DEC_Division_undefined \
...
# define DEC_Errors                                               \
 ( DEC_IEEE_754_Division_by_zero | DEC_IEEE_754_Invalid_operation \

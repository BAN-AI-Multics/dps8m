...
case 1:
   ...
   (void)fprintf(stderr,"\n");
   (void)fprintf(stderr,"   prt2pdf(1) reads input from standard input. The first character of each line\n");
   (void)fprintf(stderr,"   is interpreted as a control character. Lines beginning with any character\n");
   (void)fprintf(stderr,"   other than those listed in the ASA carriage-control characters table are\n");
   (void)fprintf(stderr,"   interpreted as if they began with a blank, and an appropriate diagnostic\n");
   (void)fprintf(stderr,"   appears on standard error. The first character of each line is not printed.\n");
   (void)fprintf(stderr,"\n");
   (void)fprintf(stderr,"     +------------+-----------------------------------------------+\n");
   ...
   (void)fprintf(stderr,"       (i.e. use ASCII extended character set)\n");
   (void)fprintf(stderr,"\n");
   ...
   (void)fprintf(stderr,"OTHER OPTIONS:\n");
   (void)fprintf(stderr,"   -S 0             # right shift 1 for non-ASA files\n");
   (void)fprintf(stderr,"   -N               # add line numbers\n");
   (void)fprintf(stderr,"\n");
   (void)fprintf(stderr,"VERSION AND HELP:\n");
   (void)fprintf(stderr,"   -v               # version number\n");

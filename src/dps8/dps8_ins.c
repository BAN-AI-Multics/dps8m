	...
	rewrite_table[] =
	  {
	    ...
	    { { 000001400020, 0000000000000, 0000001000100, 0000000000000, 0000014400000, 0110013000500, 0110013011000, 0110013011000 },
	      { 000001400020, 0000000000000, 0000001000100, 0000000000000, 0000014400000, 0110013000000, 0110013011000, 0110013011000 },
	      "pa865 test-03b inhibit", //                                                           rfi
	    },
	    { { 0000001000020, 0000000000000, 0000001000100, 0000000000000, 0000014500200, 0110013000500, 0110013011000, 0110013011000 },
	      { 0000001000020, 0000000000000, 0000001000100, 0000000000000, 0000014500200, 0110013000000, 0110013011000, 0110013011000 },
	      "pa865 test-03c inhibit", //                                                           rfi
	    },
	    { { 00000000401001, 0000000000041, 0000001000100, 0000000000000, 0101175000220, 0000006000000, 0100006235100, 0100006235100 },
	      { 00000000601001, 0000000000041, 0000001000100, 0000000000000, 0101175000220, 0000006000000, 0100006235100, 0100006235100 },
...
static void words2scu (word36 * words)
{
    ...
    sim_debug (DBG_TRACEEXT|DBG_AVC, & cpu_dev, "%s sets XSF to %d\n", __func__, cpu.cu.XSF);
...
//
    ...
    //if (get_addr_mode () != APPEND_mode)
      cpu.cu.XSF = 0;
    sim_debug (DBG_TRACEEXT|DBG_AVC, & cpu_dev, "%s sets XSF from %d to %d\n", __func__, oldXSF, cpu.cu.XSF);

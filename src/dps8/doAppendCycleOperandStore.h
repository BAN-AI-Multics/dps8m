 ...
 * scspell-id: 2b0da7ec-171d-11ee-a633-80ee73e9b8e7
 *
 * ---------------------------------------------------------------------------
 *
...
HI:
  ...
  if (cpu.useZone)
    core_write_zone (cpup, finalAddress, * data, "OPERAND_STORE");
  else
    core_writeN (cpup, finalAddress, data, nWords, "OPERAND_STORE");

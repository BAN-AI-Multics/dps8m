...
// NonEIS
    ...
    {NULL, 0, 0, 0, 0},
    {NULL, 0, 0, 0, 0},
    {"ldqc", RMW | OPEN_GATE, NO_DDCSS, 0, ru_Q},
    {"adl", READ_OPERAND, NO_CSS, 0, ru_AQ},
    {"ldac", RMW | OPEN_GATE, NO_DDCSS, 0, ru_A},
    ...
    {"stac", RMW | NO_RPL | NO_BAR | OPEN_GATE, NO_DDCSS, 0, ru_A},
    ...
    {"stacq", RMW | NO_RPL | NO_BAR | OPEN_GATE, NO_DDCSS, 0, ru_AQ},

...
static inline void set_apu_status (cpu_state_t *cpuPtr, apuStatusBits status)
  {
...
word24 do_append_cycle (cpu_state_t *cpuPtr, processor_cycle_type thisCycle,
...
static inline void fauxDoAppendCycle (cpu_state_t *cpuPtr, processor_cycle_type thisCycle)
  {

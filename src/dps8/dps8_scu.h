...
void scu_init (void);
t_stat scu_sscr (cpu_state_t * cpuPtr, uint scu_unit_idx, UNUSED uint cpu_unit_idx, uint cpu_port_num, word18 addr,
                 word36 rega, word36 regq);
t_stat scu_smic (uint scu_unit_idx, uint UNUSED cpu_unit_idx, uint cpu_port_num, word36 rega);
t_stat scu_rscr (cpu_state_t * cpuPtr, uint scu_unit_idx, uint cpu_unit_idx, word18 addr, word36 * rega, word36 * regq);

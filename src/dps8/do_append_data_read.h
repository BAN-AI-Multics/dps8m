word24 do_append_data_read (word36 * data, uint nWords)
  {
    DCDstruct * i = & cpu.currentInstruction;
    DBGAPP ("do_append_cycle(Entry) thisCycle=APU_DATA_READ\n");
...
HI:
    ...
    core_readN (finalAddress, data, nWords, "APU_DATA_READ");

...
void Read (word18 addr, word36 *dat, processor_cycle_type cyctyp, do_append_cycle_t dac);
void Read2 (word18 addr, word36 *dat, processor_cycle_type cyctyp, do_append_cycle_t dac);
void Write (word18 addr, word36 dat, processor_cycle_type cyctyp, do_append_cycle_t dac);

...
# PGO для МЦСТ Эльбрус 2000 (MCST Elbrus2K) LCC v1.26+
# Протестировано на LCC v1.27.17 на ОС Эльбрус и Альт
...
# недостаточно хорошо, поскольку компилятор LCC 1.27 не поддерживает

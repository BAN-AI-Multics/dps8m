...
* Once installed, it can be used for compilation by setting `CC=/usr/local/bin/clang` and `LDFLAGS="-fuse-ld=lld"`.
...
* The following instructions were verified using **macOS 14.4** with **Xcode 15.3** (Apple Clang 15.0.0).

...
* The simulator is distributed as an [**easy-to-build**](https://dps8m.gitlab.com/dps8m/Documentation/Source_Compilation) source code [**distribution**](https://dps8m.gitlab.com/dps8m/Releases) (buildable simply via **`make`** on most systems) or as ready-to-run [**pre-compiled binaries**](https://dps8m.gitlab.com/dps8m/Releases) for several popular platforms.
